...
describe("ProductForm", () => {
  ...
  it("should render a toast message if form submit fails", async () => {
    const { waitForFormToLoad, onSubmit } = renderComponent();
  ...
  it("should re-enable the submit button when submitting finish", async () => {
    const { waitForFormToLoad, onSubmit } = renderComponent();
  ...
  it("should re-enable the submit button when submitting fails", async () => {
    const { waitForFormToLoad, onSubmit } = renderComponent();
